        ...
        <div className="hero-section container-fluid position-relative overflow-hidden">
            <div className="hero-inner row">
                ...
                <div className="col-lg-6 ps-lg-5 col-12 text-lg-start pt-5 pe-2 mt-5 mb-lg-5">
                    <h1 className="hero-title">Great learning comes alive with visuals!</h1>
                    <p className="hero-subtitle">Visualize, learn, and master algorithms with ease.</p>
                    <button className="btn btn-primary btn-start" onClick={handleStartClick}>
                        Start Visualizing!
                    </button>
                </div>
